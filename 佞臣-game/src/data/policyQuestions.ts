...
export const POLICY_QUESTIONS: PolicyQuestion[] = [
    ...
    },
    {
        ...
        question: '北虏侵扰北周边境，敌人自顾不暇。此喘息期当如何利用？',
        options: [
    ...
    },
    {
        ...
        question: '北朝西线未靖而朝堂争执不休，我朝已积数年。是西进征蜀，还是继续养国？',
        options: [
    ...
    },
    {
        ...
        round: 13,
        topic: '灾疫治理',
        background: '佛寺借赈济扩张，寺院经济开始侵蚀税基与人口控制。',
        question: '佛寺侵占田亩人口，当如何处置？',
        options: [
