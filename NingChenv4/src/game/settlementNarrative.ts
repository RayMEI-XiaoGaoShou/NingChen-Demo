...
export function buildJudgeFacts(params: {
    ...
    const courtExposure = getCourtExposurePresentation(params.pressureUpdate.playerSuspicionHeat, params.deathCheck.nextStage)
    ...
    return {
        ...
        survivalSummary: `${courtExposure.label}；${courtExposure.summary}${suspicionReason}`,
        aiNativeSummary,
    }
}
