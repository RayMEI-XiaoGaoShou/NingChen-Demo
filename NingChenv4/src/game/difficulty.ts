...
export const DIFFICULTY_PROFILES: Record<GameDifficulty, DifficultyProfile> = {
    ...
    normal: {
        ...
        onboarding: { showFullOmenGuide: true, fengDaozhiAssistsPerRound: 2 },
    },
    hard: {
        id: 'hard',
        label: '困难',
        ...
        externalThresholdOffset: { trust: 0, loyalty: 0 },
        onboarding: { showFullOmenGuide: false, fengDaozhiAssistsPerRound: 1 },
    },
    hell: {
        id: 'hell',
        label: '地狱',
        ...
        externalThresholdOffset: { trust: 0, loyalty: 0 },
        onboarding: { showFullOmenGuide: false, fengDaozhiAssistsPerRound: 0 },
    },
}
