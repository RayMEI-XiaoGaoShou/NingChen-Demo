...
export type PrologueStep = 'COVER' | 'OPENING_CINEMATIC' | 'PROLOGUE' | 'GAMEPLAY_GUIDE' | 'CHARACTER_BIOS' | 'INGAME'
...
export type FirstRoundGuideKey =
    ...
    | 'scheme_card_advise'
    | 'scheme_card_slander'
    | 'scheme_card_alienate'
    | 'scheme_card_frame'
    | 'scheme_card_proxy'
    | 'scheme_card_secession'
    | 'scheme_card_omen'
    | 'empress_letter'
    | 'scheme_feedback'
    | 'empress_reply'
...
export interface EndingReport {
    title: string
    tier: EndingTier
    deathSource?: 'dowager_favor' | 'legacy_court' | null
    causeSummary: string[]
