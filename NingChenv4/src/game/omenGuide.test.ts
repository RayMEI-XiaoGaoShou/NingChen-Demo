...
const seenSchemeGuide = {
    ...
    court_observe: true,
    court_faction: true,
    external_faction: true,
    npc_detail: true,
    scheme_phase: true,
    scheme_card_advise: true,
    scheme_card_slander: true,
    scheme_card_alienate: true,
    scheme_card_frame: true,
    scheme_card_proxy: true,
    scheme_card_secession: true,
    scheme_card_omen: true,
    empress_letter: true,
