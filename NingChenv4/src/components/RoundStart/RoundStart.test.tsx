...
describe('RoundStart compact layout', () => {
    ...
    it('routes the first-round guide through the Feng Daozhi dialogue overlay', () => {
        expect(roundStartSource).toContain("import { buildFirstRoundGuideSequence } from '../../game/fengDaozhiGuide'")
        expect(roundStartSource).toContain("import { FengDaozhiDialogueOverlay } from '../FengDaozhiDialogue/FengDaozhiDialogueOverlay'")
        expect(roundStartSource).toContain('<FengDaozhiDialogueOverlay')
        expect(roundStartSource).toContain("sequences={[buildFirstRoundGuideSequence('round_start')]}")
        expect(roundStartSource).toContain("onComplete={() => markFirstRoundGuideSeen('round_start')}")
        expect(roundStartSource).not.toContain('dialogue-skip')
        expect(roundStartSource).not.toContain('handleSkip')
        expect(roundStartSource).not.toContain("import { FirstRoundGuideModal } from '../FirstRoundGuide/FirstRoundGuideModal'")
        expect(roundStartSource).not.toContain('<FirstRoundGuideModal')
    })
