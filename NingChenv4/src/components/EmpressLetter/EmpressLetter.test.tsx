...
describe('EmpressLetter southern letter UI contract', () => {
    it('keeps the policy selection and submission flow intact', () => {
        ...
        expect(empressLetterSource).toContain("import { useGameSfx } from '../../audio/gameSfx'")
        expect(empressLetterSource).toContain('getEmpressOptionSfxKey')
        expect(empressLetterSource).toContain('const { playSfx } = useGameSfx()')
        expect(empressLetterSource).toContain('playSfx(optionSfx)')
        expect(empressLetterSource).toContain("playSfx('empress-next-page')")
