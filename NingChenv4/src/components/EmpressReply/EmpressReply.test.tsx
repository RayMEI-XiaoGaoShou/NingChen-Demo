...
describe('EmpressReply source contract', () => {
    ...
    it('places the summary, reply body, authored-reason judgment, and effects inside the scroll', () => {
        ...
        expect(cssRule('.empress-reply-reply-panel')).toContain('left: 39.6cqw')
        expect(cssRule('.empress-reply-reply-panel')).toContain('top: 32.2cqh')
        expect(cssRule('.empress-reply-reply-panel')).toContain('width: 47.2cqw')
        expect(cssRule('.empress-reply-lower-grid')).toContain('left: 39.6cqw')
        expect(cssRule('.empress-reply-lower-grid')).toContain('top: 63.2cqh')
        expect(cssRule('.empress-reply-lower-grid')).toContain('width: 47.2cqw')
        expect(cssRule('.empress-reply-lower-grid')).toContain('grid-template-columns: 0.38fr 0.62fr')
        expect(cssRule('.empress-reply-lower-grid')).toContain('gap: 3.6cqw')
