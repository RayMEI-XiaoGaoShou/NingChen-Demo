...
describe('SchemePanel layout labels', () => {
    ...
    it('routes first-round scheme and scheme-card guides through the Feng Daozhi dialogue overlay', () => {
        expect(schemePanelSource).toContain("import { buildFirstRoundGuideSequence } from '../../game/fengDaozhiGuide'")
        expect(schemePanelSource).toContain("import { FengDaozhiDialogueOverlay } from '../FengDaozhiDialogue/FengDaozhiDialogueOverlay'")
        expect(schemePanelSource).toContain("buildFirstRoundGuideSequence('scheme_phase')")
        expect(schemePanelSource).toContain('getSchemeCardFirstRoundGuideKey')
        expect(schemePanelSource).toContain('scheme_card_omen')
        expect(schemePanelSource).toContain('scheme_card_secession')
        expect(schemePanelSource).not.toContain('SchemeOnboardingModal')
        expect(schemePanelSource).not.toContain('OmenTeachingModal')
    })
