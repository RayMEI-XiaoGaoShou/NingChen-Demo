...
const ENDING_TEXT: Record<GameResult, { title: string; description: string; flavor: string }> = {
    ...
    VICTORY: {
        title: '十 年 一 剑',
        description: '十年暗棋落定。南陈综合国力终于超越北周，女帝陈倩挥师北伐，一统天下。',
        flavor: '你，萧宝颖，这个潜伏在北周朝堂十年的佞臣，终于完成了此生最大的使命。那些权谋、算计、背叛、隐忍……都在这一刻有了意义。',
    },
    DEFEAT_DEATH: {
        title: '身 死 朝 堂',
    ...
    DEFEAT_POWER: {
        ...
        flavor: '你已尽力，却仍不够。北周虽被你搅得风声鹤唳，终究根基太深。南陈的北伐之梦，还要再等下一个十年。',
    },
}
